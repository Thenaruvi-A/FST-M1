...
SELECT order_no, SUM(purchase_amount) AS purchasetotal FROM orders GROUP  BY order_no;
--Write an SQL statement to find the average purchase amount of all orders.
SELECT order_no, AVG(purchase_amount) AS purchaseavg FROM orders GROUP  BY order_no;
--Write an SQL statement to get the maximum purchase amount of all the orders.
SELECT  MAX(purchase_amount) AS maxpurchase FROM orders;
--Write an SQL statement to get the minimum purchase amount of all the orders.
   SELECT  MIN(purchase_amount) AS minpurchase FROM orders; 
...
SELECT salesman_id, order_date, MAX(purchase_amount) where 
